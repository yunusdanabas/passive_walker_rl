...
Test for the enhanced environment with contact information.
Shows real-time contact status and prints contact data to screen.
"""
...
def test_contact_info():
    """Test contact information with console visualization."""
    print("=" * 60)
    print("CONTACT INFORMATION TEST")
    print("=" * 60)
    
    # Create environment without GUI
    env = PassiveWalkerEnv(mode="fsm", use_gui=False)
    
    print(f"✅ Environment created (headless mode)")
    ...
    print(f"\nStarting simulation (headless mode)...")
...
def test_contact_visualization():
    """Test contact visualization with console output."""
    print("\n" + "=" * 60)
...
if __name__ == "__main__":
    print("Starting Contact Information Tests...")
    print("Contact information will be displayed in the console")
    print("Running in headless mode (no GUI required)")
    print()
    
    try:
        # Run the main contact test
        test_contact_info()
