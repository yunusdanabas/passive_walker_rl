"""
Train a BC model for hip and knee control using L1 loss.
...
to minimize the L1 (absolute) loss between predicted and demonstrated actions.

Usage:
    python -m passive_walker.bc.hip_knee_alternatives.train_l1 [--steps N] [--hz H] [--gpu]
"""
...
def main():
    """Main function to train the BC model with L1 loss."""
    ...
    model = train_model(obs, labels, loss_type="l1")
